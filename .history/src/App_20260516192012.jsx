...
// Icône Wave : carré bleu arrondi avec une vague blanche (s'inspire du logo Wave)
...
export default function App() {
  ...
  const [orderSent, setOrderSent]     = useState(false);  // true après envoi de la commande sur WhatsApp (étape 1)
  ...
  // Reset l'étape de commande si le panier ou le mode change
  ...
  // ── HANDLER DU BOUTON FINALISER ─────────────────────────────────────────────
  // Flux Wave inversé : 1) on envoie d'abord la commande sur WhatsApp,
  // 2) puis le bouton bascule sur "Payer sur Wave"
                ...
                {paymentMode === "wave" && (
                  <div style={{ background: `${WAVE_BLUE}10`, border: `1px solid ${WAVE_BLUE}44`, borderRadius: "14px", padding: "16px", marginBottom: "18px" }}>
                    ...
                    <div style={{ color: "rgba(255,255,255,0.75)", fontSize: "13px", lineHeight: "1.6", marginBottom: "12px" }}>
                      Paiement sécurisé vers <strong>Parfumerie de la Zac</strong> :
                    </div>
                    ...
                    <div style={{ color: "rgba(255,255,255,0.45)", fontSize: "11px", lineHeight: "1.5" }}>
                      💡 <strong>1.</strong> Cliquez sur "Envoyer ma commande sur WhatsApp" → la boutique reçoit votre commande • <strong>2.</strong> Revenez ici et cliquez sur "Payer sur Wave" → l'app s'ouvre avec le montant déjà rempli • <strong>3.</strong> Validez le paiement ✨
                    </div>
                  </div>
                )}
